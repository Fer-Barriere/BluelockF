...
export class PartidoService {
    ...
    private apiUrl = 'http://localhost:5000/api/partidos'; // API de prueba
    ...
    agregarPartido(jugadores: string[]): Observable<Partido> {
        ...
        return this.http.post<Partido>(`${this.apiUrl}/generar`, { ids: jugadores });
    }
    // Método para eliminar un partido
    eliminarPartido(partidoId: string): Observable<void> {
        return this.http.delete<void>(`${this.apiUrl}/eliminarPartido/${partidoId}`);
    }    
}
